      ...
      <div className="bg-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-600">We make it simple to connect, partner, and grow. Our platform is designed specifically for the needs of Indian agriculture.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Negotiate fair terms for land partnerships, crop sharing, or labor contracts. We help you find the best value.</p>
            </div>
            <div className="text-center">
              <div className="bg-primary-50 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 text-3xl">
